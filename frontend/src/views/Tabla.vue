...
<v-container>
    ...
    <v-data-table :headers="headers" :items="desserts" sort-by="calories" class="elevation-1">
                ...
                <v-dialog v-model="dialog" max-width="500px">
                    ...
                    <v-card>
                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field v-model="editedItem.nombre" label="Nombre del estudiante"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field v-model="editedItem.materia" :items="Materias" label="materia"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="blue darken-1" text @click="editarEstudinte(editedItem)">
                                Modificar
                            </v-btn>
                        </v-card-actions>
                    </v-card>
        ...
        <template v-slot:item.actions="{ item }">
            ...
            <v-icon small @click="eliminarEstudiante(item._id)">
                mdi-delete
            </v-icon>
        </template>
    ...
    methods: {
        ...
        eliminarEstudiante(id) {
            ...
            this.axios.delete(`/eliminarParametro/${id}`)
                .then(res => {
                       this.$swal('OK!',
                    'Estudiente ELIMINADO exitosamente!',
                    'error');
